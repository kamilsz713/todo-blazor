...
namespace Todo.Frontend.Fluent
{
    public class FluentValidator<TValidator> : ComponentBase where TValidator : IValidator, new()
    {
        ...
        [Inject] private ILogger<FluentValidator<TValidator>> _logger { get; set; }
        ...
        protected override void OnInitialized()
        {
            ...
            EditContext.OnFieldChanged += (sender, eventArgs)
                => ValidateField((EditContext)sender, eventArgs);
        ...
        private void ValidateField(EditContext editContext, FieldChangedEventArgs field)
        {
            _logger.Log(LogLevel.Debug, JsonConvert.SerializeObject(field));
        }
